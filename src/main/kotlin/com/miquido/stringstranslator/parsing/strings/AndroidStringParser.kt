...
import com.miquido.stringstranslator.model.parsing.StringPluralsResources
import com.miquido.stringstranslator.model.parsing.StringResources
...
class AndroidStringParser : StringParser, KoinComponent {
    ...
    private fun generateStringsModel(input: String, baseLanguageCode: String): ParsedStringTranslationModel {
    ...
    private fun takePluralStringsFromFile(path: StringsFilePath): PluralStringValuesModel {
        ...
        parsePluralStringResources(path.value).stringsList.forEach { stringModel ->
            ...
            stringModel.quantityList.forEach { quantityValue ->
                val pluralQualifier =
                    try {
                        PluralQualifier.valueOf(quantityValue.quantity.uppercase())
                ...
                if (pluralQualifier != null) pluralsQualifierMap[pluralQualifier] =
                    quantityValue.text
            }
